...
namespace GeorgianComputers.Controllers
{
    public class CartsController : Controller
    {
        ...
        public CartsController(GeorgianComputersContext context)
        {
            _context = context;
        }
        ...
        {
            var georgianComputersContext = _context.Cart.Include(c => c.Product);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("CartId,ProductId,Quantity,Price,Username")] Cart cart)
        {
            if (id != cart.CartId)
            {
                return NotFound();
