using System;
using Microsoft.AspNetCore.Identity.EntityFrameworkCore; //new identity core
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata;

namespace GeorgianComputers.Models
{
        //MODIFT the BdContext to handle the User Identities and the Roles
        //Last parameter indicated the PK of UserId values as a string
    public partial class GeorgianComputersContext : IdentityDbContext<ApplicationUser, ApplicationRole, string> //user idtentifing string, find in slides
    {
...
//                optionsBuilder.UseSqlServer("Data Source=(local);Initial Catalog=GeorgianComputers;Integrated Security=True");
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                //ADD to get Identity to work! This is a Bug fix, no explaining it, its just needed
